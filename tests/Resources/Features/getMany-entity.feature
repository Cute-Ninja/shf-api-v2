Feature:
  ...
  @api @visitor {tag}
  Scenario: As an anonymous user I cannot access the list of {entity}s
    Given I am an anonymous User
    When I request the api "{apiUrl}"
    Then access should not be authorized

  @api @user {tag}
  Scenario: As a logged user I can access the list of {entity}s
  ...
  Scenario: As a logged administrator I access the list of {entity}s
